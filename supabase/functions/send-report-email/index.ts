        ...
        html: `
          ...
          <table style="border-collapse:collapse;width:100%;max-width:500px">
            <tr>
              ...
              <td style="padding:8px;border:1px solid #eee">${reporterNickname} (${reporterId})</td>
            </tr>
            <tr>
              <td style="padding:8px;border:1px solid #eee;background:#f9f9f9;font-weight:bold">게시물 ID</td>
              <td style="padding:8px;border:1px solid #eee">${postId}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding:8px;border:1px solid #eee">${postContent ?? '(내용 없음)'}</td>
            </tr>
          </table>
